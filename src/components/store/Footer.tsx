      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 pb-12 border-b border-bc-gray-700">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-[11px] leading-relaxed text-bc-gray-500 font-light tracking-wide">
              Moda femenina con identidad.
              <br />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-[11px] text-bc-gray-500 tracking-wide">
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] text-bc-gray-700 tracking-wide uppercase">
          <span>© 2026 Blue Chic. Todos los derechos reservados.</span>
          <span>Diseñado con amor en Buenos Aires</span>
        </div>
      </div>
    </footer>
  )
